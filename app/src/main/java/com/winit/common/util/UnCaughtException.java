...
public class UnCaughtException implements UncaughtExceptionHandler {
    private static final String RECIPIENT = "mallikarjuna@winitsoftware.com,o.sandeep@winitsoftware.com";
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject = "WINIT iKonnect Log. iKonnect";
                                ...
                                ((BaseActivity)context).finishAndRemoveTask();
                                System.exit(0);
                            }
                        });
                builder.setMessage("Sorry for inconvenience. iKonnect app stopped working.");
