...
public class PersonalChatRoomAdapter extends RecyclerView.Adapter<PersonalChatRoomAdapter.ViewHolder>
{
    private Context context;
    private List<ChatMessage> chatMessages;
    private String userId;
    public PersonalChatRoomAdapter(Context context, List<ChatMessage> chatMessages) {
    ...
    @Override
    public PersonalChatRoomAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.chat_message_cell, parent, false);
        return new PersonalChatRoomAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(PersonalChatRoomAdapter.ViewHolder holder, int position)
    {
