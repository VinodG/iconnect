...
import static com.winit.iKonnect.R.id.rbHRAdvanceNo;
import static com.winit.iKonnect.R.id.rbHRAdvanceYes;
...
public class VisitVisaForinLawsChildren extends FormActivity {
    ...
    protected void initializeForm() {
        ...
        visaSpouseChildrenDO=(VisaSpouseChildrenDO)getIntent().getSerializableExtra(this.getResources().getString(R.string.Visit_Visa_for_In_laws_children));
        ...
        tvVisaCost.setText("Visa Cost"+" 20 OMR");
    ...
    public void showAlert(String type) {
        ...
        if (message.equalsIgnoreCase(AppConstants.Logout))
            showCustomDialog(VisitVisaForinLawsChildren.this, getString(R.string.alert), getString(R.string.force_logout), getString(R.string.OK), "", "forcelogout", false);
        else
            showCustomDialog(VisitVisaForinLawsChildren.this, getString(R.string.alert), message, getString(R.string.OK), "", "");
    }
    ...
    public void postData(View view) {
        ...
        iFormPresenter.VisaInLawsChildren(
    ...
    private void bindData() {
        ...
        DateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getSelectedDateFromDatePicker(VisitVisaForinLawsChildren.this, DateOfBirth);
            }
        });
        DateOfIssue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSelectedDateFromDatePicker(VisitVisaForinLawsChildren.this, DateOfIssue);
            }
        });
        DateOfExpiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //showDatePickerDialog(VisitVisaForinLawsChildren.this, DateOfExpiry);
                getSelectedDateFromDatePicker(VisitVisaForinLawsChildren.this, DateOfIssue.getText().toString(), DateOfExpiry);
            }
        });
        DateOfLastEntry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDatePickerDialog(VisitVisaForinLawsChildren.this, DateOfLastEntry);
            }
        });
    ...
    public void spinnerShow(final View view) {
        AlertDialog dialog;
        final CharSequence str[] = {"Father-in-Law", "Mother-in-Law", "Son", "Daughter"};
