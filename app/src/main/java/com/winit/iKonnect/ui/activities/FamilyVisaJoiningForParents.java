...
import static com.winit.iKonnect.R.id.rbBankLoanNo;
import static com.winit.iKonnect.R.id.rbBankLoanYes;
import static com.winit.iKonnect.R.id.rbCreditCardNo;
import static com.winit.iKonnect.R.id.rbCreditCardYes;
import static com.winit.iKonnect.R.id.rbTransAdvanceNo;
import static com.winit.iKonnect.R.id.rbTransAdvanceYes;
import static com.winit.iKonnect.R.id.tvLabourAppli_cost;

/**
 * Created by Ojha.Sandeep on 10/26/2017.
 */

public class FamilyVisaJoiningForParents extends FormActivity {
    ...
    @Nullable
    @Bind(R.id.etReason_new)
    EditText etReason_new;
    ...
    protected void initializeForm() {
        ...
        visaSpouseChildrenDO=(VisaSpouseChildrenDO) getIntent().getSerializableExtra(this.getResources().getString(R.string.Family_Joining_Visa_for_Parents));

        inflater.inflate(R.layout.visit_visa_for_inlaws_children, flFormBody, true);
        ...
        tvVisaCost.setText("Visa- Family Joining (all)- 30 OMR");
    ...
    public void showAlert(String type) {
        ...
        switch (type) {
            ...
            case R_SHIP_WITH_APPLI:
                ...
                break;
            case REASON_REQUEST:
                message = getString(R.string.reason_request);
                break;
            case ANY_BANK_LOAN:
        ...
        if (message.equalsIgnoreCase(AppConstants.Logout))
            showCustomDialog(FamilyVisaJoiningForParents.this, getString(R.string.alert), getString(R.string.force_logout), getString(R.string.OK), "", "forcelogout", false);
        else
            showCustomDialog(FamilyVisaJoiningForParents.this, getString(R.string.alert), message, getString(R.string.OK), "", "");
    }
    ...
    public void postData(View view) {
        ...
        iFormPresenter.FamilyVisaParents(
    ...
    private void bindData() {
        DateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getSelectedDateFromDatePicker(FamilyVisaJoiningForParents.this, DateOfBirth);
            }
        });
        DateOfIssue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSelectedDateFromDatePicker(FamilyVisaJoiningForParents.this, DateOfIssue);
            }
        });
        DateOfExpiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //showDatePickerDialog(FamilyVisaJoiningForParents.this, DateOfExpiry);
                getSelectedDateFromDatePicker(FamilyVisaJoiningForParents.this, DateOfIssue.getText().toString(), DateOfExpiry);
            }
        });
        DateOfLastEntry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDatePickerDialog(FamilyVisaJoiningForParents.this, DateOfLastEntry);
            }
        });
    ...
    public void spinnerShow(final View view) {
        AlertDialog dialog;
        final CharSequence str[] = {"Father", "Mother"};
    ...
    public void showAlert(String message, ServiceDO serviceRequestDO) {
        ...
        if (serviceRequestDO != null)
            ...
            showFormSubmitPopup("Family Visa Joining For Parents", message);
        }
    }
    ...
    private void showAllContent() {
        ...
        etReason_new.setText(visaSpouseChildrenDO.getReasonrequest());
