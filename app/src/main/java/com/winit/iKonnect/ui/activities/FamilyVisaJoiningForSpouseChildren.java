...
import static com.winit.iKonnect.R.id.etReason_new;
...
public class FamilyVisaJoiningForSpouseChildren extends FormActivity {
    ...
    protected void initializeForm() {
        ...
        visaSpouseChildrenDO=(VisaSpouseChildrenDO)getIntent().getSerializableExtra(this.getResources().getString(R.string.Family_Joining_Visa_for_Spouse_children));
        ...
        tvVisaCost.setTypeface(AppConstants.BOLD);
    ...
    public void showAlert(String type) {
        ...
        if (message.equalsIgnoreCase(AppConstants.Logout))
            showCustomDialog(FamilyVisaJoiningForSpouseChildren.this, getString(R.string.alert), getString(R.string.force_logout), getString(R.string.OK), "", "forcelogout", false);
        else
            showCustomDialog(FamilyVisaJoiningForSpouseChildren.this, getString(R.string.alert), message, getString(R.string.OK), "", "");
    }
    ...
    public void postData(View view) {
        ...
        iFormPresenter.FamilyVisaSpouseChildren(
    ...
    private void bindData() {
        DateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getSelectedDateFromDatePicker(FamilyVisaJoiningForSpouseChildren.this, DateOfBirth);
            }
        });
        DateOfIssue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSelectedDateFromDatePicker(FamilyVisaJoiningForSpouseChildren.this, DateOfIssue);
            }
        });
        DateOfExpiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // showDatePickerDialog(FamilyVisaJoiningForSpouseChildren.this, DateOfExpiry);
                getSelectedDateFromDatePicker(FamilyVisaJoiningForSpouseChildren.this, DateOfIssue.getText().toString(), DateOfExpiry);
            }
        });
        DateOfLastEntry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDatePickerDialog(FamilyVisaJoiningForSpouseChildren.this, DateOfLastEntry);
            }
        });
    ...
    public void spinnerShow(final View view) {
        AlertDialog dialog;
        final CharSequence str[] = {"Husband", "Wife", "Son", "Daughter"};
